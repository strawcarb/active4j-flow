...
public interface FlowVersionUploadApprovalService extends IService<FlowVersionUploadApproveEntity> {
    ...
    void saveNewVersion(WorkflowBaseEntity workflowBaseEntity, FlowVersionUploadApproveEntity entity);

    Boolean saveOrUpdate(WorkflowBaseEntity workflowBaseEntity, FlowVersionUploadApproveEntity entity);
