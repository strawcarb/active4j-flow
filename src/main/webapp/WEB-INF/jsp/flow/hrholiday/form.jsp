...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input class="laydate-icon form-control layer-date" id="startDay" name="startDay"
               value='<fmt:formatDate value="${biz.startDay }" type="date" pattern="yyyy-MM-dd"/>'>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">结束日期：</label>
    <div class="col-sm-5">
        <input class="laydate-icon form-control layer-date" id="endDay" name="endDay"
               value='<fmt:formatDate value="${biz.endDay }" type="date" pattern="yyyy-MM-dd"/>'>
    </div>
</div>
<div class="form-group">
